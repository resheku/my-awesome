...
- [techascent/tmducken](https://github.com/techascent/tmducken) - tech.ml.dataset integration with duckdb
...
- [Basekick-Labs/arc](https://github.com/Basekick-Labs/arc) - Open, SQL-native time-series database for telemetry you need to keep. 34M+ records/sec ingestion, 8M+ rows/sec queries. InfluxDB Line Protocol and Telegraf compatible. Open Parquet on your storage. Single binary. S3/Azure native. Air-gap ready. AGPL-3.0.
...
- [cloudbase/garm](https://github.com/cloudbase/garm) - Multi-cloud, auto-scaling manager for GitHub Actions & Gitea self-hosted runners with pluggable providers
...
- [entropy-data/data-landscape](https://github.com/entropy-data/data-landscape) - Interactive landscape of the open standards that power a modern data architecture — data-landscape.com
...
- [earthgecko/skyline](https://github.com/earthgecko/skyline) - Real-time anomaly detection for time series metrics. 11 years of production anomaly detection evolution. Multi-algorithm ensembles. Pattern recognition using semi-supervised and unsupervised learning. Correlation analysis. Learns and gets better over time.  No GPU required, can run on a VPS.
...
- [ebonnal/streamable](https://github.com/ebonnal/streamable) - sync/async iterable streams for Python
...
- [idesis-gmbh/GitHubExperiments](https://github.com/idesis-gmbh/GitHubExperiments) -  Experiments with GitHub event data 
...
- [leontrolski/postgresql-testing](https://github.com/leontrolski/postgresql-testing) - Postgresql testing for Python/Pytest
...
- [npcole/npyscreen](https://github.com/npcole/npyscreen) - User interfaces for the terminal without all that mucking about in hyperspace.
...
- [olle-lindgren/pyrefact](https://github.com/olle-lindgren/pyrefact) - Automatic python refactoring
...
- [zopefoundation/zope.component](https://github.com/zopefoundation/zope.component) - Core of the Zope Component Architecture (ZCA)
...
- [columnar-tech/databow](https://github.com/columnar-tech/databow) - A command-line tool for querying databases
...
- [dxmachina/warp-nine](https://github.com/dxmachina/warp-nine) - WarpNine is a terminal born out of a bloated terminal.
...
- [leonickson1/Swiftlet](https://github.com/leonickson1/Swiftlet) - Swiftlet is a Swift and Metal runtime that runs large Qwen Mixture-of-Experts models locally on Apple devices by streaming expert weights from storage, enabling 35B and 80B models to run with low RAM, including on iPhone.
...
- [powtac/wtm](https://github.com/powtac/wtm) - What The Model — Local LLM Inventory for macOS
...
- [cloudflare/cloudflare-os-starter](https://github.com/cloudflare/cloudflare-os-starter) - A guide for customizing your Cloudflare OS deployment
...
- [setchy/thoughtworks-tech-radar-volumes](https://github.com/setchy/thoughtworks-tech-radar-volumes) - CLI and complete collection of Thoughtworks Technology Radar datasets (JSON, CSV and Google Sheets)
...
- [datasets/commons](https://github.com/datasets/commons) - DataHub commons. Interesting and important datasets

...
- [theOGognf/finagg](https://github.com/theOGognf/finagg) - A Python package for aggregating historical data from popular and free financial APIs, and for transforming that data into features for AI/ML.

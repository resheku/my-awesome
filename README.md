...
- [webanno/webanno](https://github.com/webanno/webanno) - The Official WebAnno Repository
...
- [intake/filesystem_spec](https://github.com/intake/filesystem_spec) - A specification that python filesystems should adhere to.
